    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_profil);
            ...
            igg.setOnClickListener(new View.OnClickListener() {
              @Override
                public void onClick(View view) {
                    Intent toIg = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.instagram.com/malshawnchusaeni/?hl=en"));
                    startActivity(toIg);
                }
            });
            ...
            fbb.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent toFb = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.facebook.com/atlarikputra"));
                    startActivity(toFb);
                }
            });
    }
